...
from keras.layers import Activation, Conv2D, MaxPooling2D, Flatten, Dense, Dropout, LeakyReLU, Lambda, ELU, Activation
...
def create_comma_model_relu(input_shape: List[int], alpha: float = 0.3):
    ...
    model.add(Convolution2D(16, (8, 8), strides=(4, 4), padding="same", input_shape=input_shape))
...
def create_comma_model5(input_shape: List[int], alpha: float = 0.3):
    ...
    model.add(Convolution2D(32, (8, 8), strides=(4, 4), padding="same", input_shape=input_shape))
    model.add(Activation('relu'))
    model.add(Convolution2D(64, (5, 5), strides=(2, 2), padding="same"))
    model.add(Activation('relu'))
    model.add(Convolution2D(64, (5, 5), strides=(2, 2), padding="same"))
...
def create_nvidia_model1(input_shape: List[int], alpha: float = 0.3):
    ...
    model.add(Convolution2D(24, (5, 5), strides=(2, 2), padding="same", input_shape=input_shape))
    model.add(Activation('relu'))
